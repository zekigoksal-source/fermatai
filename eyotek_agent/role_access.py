...
_ACL_MATRIX: dict[str, set[str]] = {
    ...
    "admin": {
        ...
        "get_student_daily_summary", "predict_yks_score", "get_knowledge_state", "get_exam_xray", "get_digital_twin", "generate_practice_question", "check_practice_answer", "remember_student_insight", "observe_student_answer",
    },
    ...
    "yonetim": {
        ...
        "get_adaptive_summary", "get_knowledge_graph", "analyze_student_study_pattern",
        "get_student_daily_summary", "predict_yks_score", "get_knowledge_state", "get_exam_xray", "get_digital_twin", "generate_practice_question", "check_practice_answer", "remember_student_insight",
    },
