...
async def get_dynamic_photo_limit(soz_no: str, base_limit: int = 3) -> int:
    """Aktif ogrenciye ek foto hakki ver."""
    if not soz_no:
        return base_limit
    try:
        # Son 7 gunde sinav verisi varsa +2
