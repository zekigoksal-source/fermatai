...
SELAMLAMA_VARYASYON = {
    ...
    "ogrenci": [
        "Selam *{name}* 👋 Bugün nasıl gidiyor?",
        "Merhaba *{name}* — neye bakalım?",
        "Hoş geldin *{name}* 😊 Aklında ne var?",
        "Selam *{name}* — söyle, dinliyorum.",
        "*{name}* 👋 hazırım, ne sormak istersin?",
        "Buradayım *{name}*. Bugün hangi konu üzerinde duralım?",
        "Merhaba 🎯 Söyle bakalım, ne yapalım?",
        "*{name}* hey 👊 nasılsın? Ne var ne yok?",
        "Selam *{name}* — bugün hangi ders seni yordu? 💪",
        "Hoş geldin *{name}* ⚡ sistem senin emrinde.",
        "*{name}* 🌟 bugün biraz çalışmak mı, biraz konuşmak mı?",
        "Merhaba *{name}* — deneme mi, konu mu, soru mu?",
    ],
    "ogretmen": [
        "Hoş geldiniz *{name}* 👋 Bugün ne üzerinde çalışalım?",
        "Selam *{name}* — programınız mı, öğrenci durumu mu?",
        "*{name}*, hazırım. Buyrun.",
        "Hoş geldiniz — gündem sizde.",
        "Selam *{name}* 👋 Sınıfla mı ilgili, yoksa başka bir şey mi?",
        "Merhaba *{name}* — öğrenci, etüt, program — hangisi?",
        "*{name}* Hocam, buyrun. Bugün ne var?",
        "Hoş geldiniz Hocam — kayıtlar hazır, sorun.",
    ],
    "rehber": [
        "Hoş geldiniz *{name}* 👋 Hangi öğrenci üzerinde duralım?",
        "Selam *{name}* — rehberlik kayıtları hazır, sorun.",
        "*{name}*, buyrun. Bugün ne yapıyoruz?",
        "Hoş geldiniz — sınıf veya öğrenci, başlayalım.",
        "*{name}* Hocam 👋 bugün hangi öğrenciye bakalım?",
        "Merhaba *{name}* — duygu takibi mi, akademik analiz mi?",
    ],
    "veli": [
        "Hoş geldiniz *{name}* 👋 Çocuğunuzla ilgili nasıl yardımcı olabilirim?",
        "Selam *{name}* — buyrun, dinliyorum.",
        "*{name}*, hazırım. Ne sormak istersiniz?",
        "Merhaba *{name}* — çocuğunuzun akademik durumu mu?",
        "Hoş geldiniz *{name}* — veli panelinde buyrun.",
    ],
}
