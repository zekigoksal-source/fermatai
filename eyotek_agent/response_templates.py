...
def get_yetenekler(role: str, name: str = "") -> str:
    ...
    if role == "ogrenci":
        return (
            ...
            "🔬 *Interaktif Bilim Simulasyonlari* (YENİ)\n"
            "PhET fizik/kimya/biyoloji deneylerini sana özel açarım — "
            "_kaldırma kuvveti, devre, dalga_ gibi konuları parmagınla deney yaparak öğren.\n\n"
            "🧮 *Wolfram Matematik Cozucu*\n"
            "İntegral, türev, denklem sistemi — _adım adım çözüm_ üretirim. "
            "Sadece sonuç değil, ARA İŞLEMLER de gözünün önünde.\n\n"
            "🎥 *Konu Anlatim Videosu Bulma*\n"
            "Takıldığın konu için YouTube'da en iyi Türkçe ders videosunu bulup gönderirim.\n\n"
            "📄 *PDF Çalışma Notu + Anki Kart Üretimi*\n"
            "Bir konuyu özetleyip PDF olarak veririm — veya direkt Anki tekrar kartı oluştururum, "
            "tekrar disiplinini ben yönetirim.\n\n"
            "🌍 *25+ Akademik Veri Kaynağı*\n"
            "NASA, ArXiv, PubChem (kimya), Wikipedia, TDK, TÜİK, AlphaFold (protein), "
            "USGS deprem, Open-Meteo hava — gerçek bilim verisine senin için bağlanırım.\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"💡 _Ve {first} — yukarıdakiler sadece bir tutam, *141 yeteneğim* var. "
            "Benimle konusurken hic kasmana gerek yok. "
            "\"Fizigim cok kotu\" de yeter, ben ne yapman gerektigini bulurum. "
            "Foto at anlarim, ses kaydı gönder Whisper ile anlarim, soru yaz cozerim. "
